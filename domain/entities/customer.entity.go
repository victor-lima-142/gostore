...
type Customer struct {
	...
	ContactID uint      `json:"contact_id"`                                                       // contact id of customer
	Contact   *Contact  `gorm:"foreignKey:CustomerID;constraint:OnDelete:CASCADE" json:"contact"` // One-to-one relationship with Contact
}
